...
const Hero = ({
  ...
  return (
    <div
      className="w-full bg-[url('/assets/backgroundandreas.jpg')] bg-cover bg-center"
    ...
    >
      ...
      >
        <ScrollAnimationWrapper>
          ...
          >
            <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
              ...
              {/* <ButtonPrimary onClick={redirectToYouTube}>Get Started</ButtonPrimary> */}
              <button
                className="py-3 lg:py-4 px-12 lg:px-16 text-white-500 font-semibold rounded-lg bg-maroon-500 hover:shadow-orange-md transition-all outline-none"
              >
                Play Video
              </button>
            </div>
        ...
        <div className="relative w-full flex mb-[-70px]">
          <ScrollAnimationWrapper className="rounded-lg w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-2 py-2 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-100 bg-white-500 z-10 ">
